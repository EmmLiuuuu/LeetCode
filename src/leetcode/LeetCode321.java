...
public class LeetCode321 {
    ...
    public static void main(String[] args) {
        new LeetCode321().maxNumber(new int[]{1}, new int[]{9, 1, 2, 5, 8, 3}, 3);
    }

    //https://leetcode-cn.com/problems/create-maximum-number/solution/
    //思路是分解问题
    /*
    问题：从长度为n的nums1中 与 长度为m的nums2 中取出数字，保持相对原数组数字顺序不变，得到长度为k的字典序最大的数组
    子问题：从nums1中取出长度为i的字典序最大的子序列，从nums2中取出长度为k-i的字典序最大的子序列，再按照字典序组合在一起，即可得出当前情况下的长度为k的字典序最大数组
    便利所有情况，找到最大的即为答案
     */
